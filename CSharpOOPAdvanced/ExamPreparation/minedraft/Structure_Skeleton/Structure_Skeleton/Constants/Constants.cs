public static class Constants
{
    ...
    public const string NoEntityFoundWithId = "No entity found with id - {0}";

    public const string SystemShutdown = "System Shutdown";

    public const string TotalEnergyProduced = "Total Energy Produced: {0}";

    public const string TotalMinedPlumbusOre = "Total Mined Plumbus Ore: {0}";

    public const string EntityToString = "{0}{1}Durability: {2}";
}