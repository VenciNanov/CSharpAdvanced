...
namespace P04_Hospital
{
    public class Program
    {
        public static void Main()
        {
            ...
            command = FillRooms(doctors, departments);

            command = Print(doctors, departments);
        }

        public static string FillRooms(Dictionary<string, List<string>> doctors, Dictionary<string, List<List<string>>> departments)
        {
            string command;
        ...
        public static string Print(Dictionary<string, List<string>> doctors, Dictionary<string, List<List<string>>> departments)
        {
            string command;
