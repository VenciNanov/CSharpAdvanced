...
namespace P06_Sneaking
{
    class Sneaking
    {
        ...
        static void Main()
        {
            ...
            FindSam(out moves, out samPosition);

            MoveSam(moves, samPosition);
        }

        public static void MoveSam(char[] moves, int[] samPosition)
        {
            for (int i = 0; i < moves.Length; i++)
            {
                MoveEnemies();

                int[] getEnemy = MoveSam(samPosition);
        ...
        public static void FindSam(out char[] moves, out int[] samPosition)
        {
        ...
        public static int[] MoveSam(int[] samPosition)
        {
