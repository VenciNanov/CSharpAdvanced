...
public class DragRace : Race
{
    ...
    {
        var winners = this.Paritcipants.Values.OrderByDescending(c => c.GetEnginePerformance())
            .Take(3)
            .ToList();
        return winners;
    }
    ...
    public override int GetPerformancePoints()
    {
        ...
        var performancePoints = winners.Sum(x => x.GetEnginePerformance());
    ...
    public override string ToString()
    {
        ...
        {
            participant = winner.GetEnginePerformance();
